\chapter{Mejora 5: Normalización}\label{znormalization}
...
\figura{1}{img/pruebas/comparacion_normaliz}{Izquierda: Normalización tipificada. Derecha: Cambio a escala $[0,1]$.}{fig:comparacion_normaliz}{}
...
\cuadro{|c|c|c|}{Métricas.}{tab:metricas_5}{
IoU fondo & IoU células\\ 
\hline
0.9811 & 0.7224\\
}

\figura{0.8}{img/pruebas/sistema_5_normalizacion_perdidas}{Pérdida de entrenamiento. 100 iteraciones.}{fig:sistema_5_normalizacion_perdidas}{}

\figura{0.8}{img/pruebas/sistema_5_normalizacion_visual}{Ejemplo de segmentación del conjunto de test. Fila 1 imagen original, fila 2 segmentación objetivo, fila 3 segmentación predicha. Columnas Z=20, Z=25, Z=45, Z=50.}{fig:sistema_5_normalizacion_visual}{}
