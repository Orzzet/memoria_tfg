...
\figura{1}{img/Diseno-unetarch-half}{Arquitectura U-Net reducida. Esta arquitectura no tiene mucho interés excepto para completar un primer sistema.}{fig:unetarch-half}{}