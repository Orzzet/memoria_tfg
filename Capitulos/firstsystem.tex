...
\cuadro{|c|c|c|}{Métricas sistema inicial. En la primera columna se muestra cómo de bien se ha predicho el fondo. En la cómo de bien se han predicho las células.}{tab:metricas_inicial}{
